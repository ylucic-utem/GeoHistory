...
const ShareCard: React.FC<ShareCardProps> = ({ data, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-200">
      <div
        ref={modalRef}
        className="bg-gray-900 border border-white/10 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200"
      >
        {/* Header */}
        ...
        {/* Card Preview */}
        <div className="p-6 flex flex-col items-center bg-gradient-to-b from-gray-900 to-gray-950">
          {isGenerating ? (
        ...
        <div className="p-4 border-t border-white/10 bg-gray-950 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={handleDownload}
              disabled={isGenerating || !cardImageUrl}
              className="flex items-center justify-center gap-2 py-3 px-4 bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 disabled:cursor-not-allowed text-white rounded-xl font-medium transition-colors"
            >
            ...
            <button
              ...
              disabled={isGenerating || !cardImageUrl}
              className="flex items-center justify-center gap-2 py-3 px-4 bg-green-600 hover:bg-green-500 disabled:bg-green-600/50 disabled:cursor-not-allowed text-white rounded-xl font-medium transition-colors"
            >
